...
Here the topographic image was uploaded to GMT and visualised using the coordinate extent by using the ‘grdimage’ module. Adding cartographic grid by the code \ref{List2} using the ‘psbasemap’ module of GMT: 
...
Text annotations using the code in \ref{List3}: 
