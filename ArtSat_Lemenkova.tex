...
\lstset{caption={Listing for GMT script visualising the 3D image in Fig. 4}, label=List6}
\begin{lstlisting}[frame=single]
...
\vspace{6pt}	
\figtab {\bf Figure 4.} 3D model of Zagros mountains. Mapping: GMT. Source: author.
\end{center}
\end{figure}
...
\newpar The default visualisation of ‘raster’ package is illustrated in Fig. 7 that  shows slope map of Iran. After the initial models were created, the data for each map in Figures 8 to 11 were imported to the ‘tmap’ package where the cartographic processing is more sophisticated. Thus, for instance, the cartographic elements are adjusted using special flags in the options of the function in a package. 
...
\vspace{6pt}	
\figtab {\bf Figure 5.} Geoid model of Iran. Mapping: GMT. Source: author.
\end{center}
\end{figure}
...
\begin{figure}[H]
\begin{center}
\includegraphics[height=10.0cm]{Fig_06.jpg}
...
\newpar The geomorphometry of Iran in general and the Zagros mountain as its particular, most remarkable landform and similar relief features (e.g. Elburz, Kopet Dag mountain chains) is visualised in the set of figures plotted in R: the evaluation of slope Fig. 7 and Fig. 8, aspect orientation of slopes Fig. 9, hillshade with artificial illumination highlighting the relief of the country (Fig. 10) and DEM based visualisation of the geomorphological properties better highlighting geologic structure of Zagros and surrounding relief (Fig. 11). These models were plotted to illustrate the complex landforms of Iran along Zagros forl and thrust belt and in other regions of country. 

\begin{figure}[H]
\begin{center}
\includegraphics[height=8.0cm]{Fig_07.jpg}
...
\begin{figure}[H]
\begin{center}
\includegraphics[height=9.0cm]{Fig_08.jpg}
...
\begin{figure}[H]
\begin{center}
\includegraphics[height=10.0cm]{Fig_09.jpg}
...
\begin{figure}[H]
\begin{center}
\includegraphics[height=10.0cm]{Fig_10.jpg}
...
\begin{figure}[H]
\begin{center}
\includegraphics[height=10.0cm]{Fig_11.jpg}
