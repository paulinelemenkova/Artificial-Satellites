...
\usepackage{color}
\usepackage{float}
\usepackage[labelfont=bf,labelsep=period,font=singlespacing,skip=-10pt,hypcapspace=0pt]{caption}
...
\vspace{6pt}	
\figtab {\bf Figure 4.} Geoid model of Iran. Mapping: GMT. Source: author.
\end{center}
\end{figure}
...
\vspace{6pt}	
\figtab {\bf Figure 5.} 3D model of Zagros mountains. Mapping: GMT. Source: author.
\end{center}
\end{figure}

\newpar The 3D modelling in Fig. 5 (3D model of Zagros mountains) was performed using the code in \ref{List6}:
...
\vspace{6pt}	
\figtab {\bf Figure 6.} Free-air gravity anomaly of Iran. Mapping: GMT. Source: author.
\end{center}
\end{figure}
...
\vspace{6pt}	
\figtab {\bf Figure 7.} R ‘raster’-based geomorphometric model of elevation. Source: author.
\end{center}
\end{figure}
...
\vspace{6pt}	
\figtab {\bf Figure 8.} Slope terrain model of Iran. Mapping: R.  Source: author.
\end{center}
\end{figure}
...
\vspace{6pt}	
\figtab {\bf Figure 9.} Aspect terrain model of Iran. Mapping: R. Source: author.
\end{center}
\end{figure} 
...
\vspace{6pt}	
\figtab {\bf Figure 10.} Hillshade terrain model of Iran. Mapping: R. Source: author.
\end{center}
\end{figure}
