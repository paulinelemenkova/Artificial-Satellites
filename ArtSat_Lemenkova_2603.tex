...
\lstset{caption={Listing for GMT script for converting the formats and visualising raster in Fig. 4},label=List1}
...
\lstset{caption={Listing for GMT script inserting a small globe map on the image in Fig. 1.},label=List4}
\begin{lstlisting}[frame=single,language=bash,basicstyle=\scriptsize]
...
\lstset{caption={Listing for GMT script visualising the 3D image in Fig. 5}, label=List6}
\begin{lstlisting}[frame=single,language=bash,basicstyle=\scriptsize]
...
\lstset{language=R,caption={Listing of R language visualising the geographic map on the image in Fig. 8},label=List9}
\begin{lstlisting}[frame=single,language=R,basicstyle=\scriptsize]
...
\begin{figure}[H]
	...
	\end{center}
\caption{Geomorphometric model of elevation made using R ‘raster’ package. Source: author.}\label{fig:07}
\end{figure}
